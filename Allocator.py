...
class Allocator:
    def solve_by_ga(self, pinit, calculator, nComponents, nUnits, nResources, filename):
    ...
    def solve_by_sa(self, pinit, calculator, nComponents, nUnits, nResources, filename):
    ...
    def solve_by_fss(self, pinit, calculator, nComponents, nUnits, nResources, filename):
